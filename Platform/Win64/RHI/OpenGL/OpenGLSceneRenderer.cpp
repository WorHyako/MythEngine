...
void OpenGLSceneRenderer::DrawOutline(MeshStructure& renderObject, glm::mat4 view, glm::mat4 projection)
{
...
void OpenGLSceneRenderer::RenderScene(
...
void OpenGLSceneRenderer::RenderDepthMapScene(
    const unsigned int framebuffer,
...
void OpenGLSceneRenderer::renderTBNQuad()
{
    if (TBNQuadVAO == 0)
    {
        // vertex coordinates
...
// -----------------------------------------
void OpenGLSceneRenderer::renderQuad()
{
    if (quadVAO == 0)
    {
        float quadVertices[] = {
...
OpenGLSceneRenderer::OpenGLSceneRenderer(GLApp* app)
    : OpenGLBaseRender(app)
{}

int OpenGLSceneRenderer::draw()
{
    ...
    unsigned int textureCubemap = OpenGLUtils::loadCubemap(faces_path);
...
void OpenGLSceneRenderer::renderSphere()
{
    if (sphereVAO == 0)
    {
