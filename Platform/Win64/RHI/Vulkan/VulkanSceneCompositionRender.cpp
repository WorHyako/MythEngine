...
SceneCompositionApp::SceneCompositionApp()
	: CameraApp(-95, -95, { false, true, false, true, true })
	...
	, envMap(ctx_.resources.loadCubemap((FilesystemUtilities::GetResourcesDir() + "textures/immenstadter_horn_2k.hdr").c_str()))
	, irrMap(ctx_.resources.loadCubemap((FilesystemUtilities::GetResourcesDir() + "textures/immenstadter_horn_2k_irradiance.hdr").c_str()))
	, sceneData(ctx_,
...
void SceneCompositionApp::draw3D()
{
...
void SceneCompositionApp::drawUI()
{
