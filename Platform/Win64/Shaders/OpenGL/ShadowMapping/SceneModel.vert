...
// Another option is to use the ARB_clip_control extension to change OpenGL clip-space to use the 0..1 range and use the same matrix for both OpenGL and Vulkan
