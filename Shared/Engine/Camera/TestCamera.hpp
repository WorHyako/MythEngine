...
class TestCamera final
{
public:
	explicit TestCamera(CameraPositionerInterface& positioner)
		:positioner_(&positioner)
	{}

	TestCamera(const TestCamera&) = default;
	TestCamera& operator = (const TestCamera&) = default;
...
private:
	...
	glm::vec3 up_ = glm::vec3(0.0f, 0.0f, 1.0);
};
