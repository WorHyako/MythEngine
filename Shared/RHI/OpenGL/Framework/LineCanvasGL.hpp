...
private:
	...
	GLShader shdLinesVertex_ = GLShader((FilesystemUtilities::GetShadersDir() + "OpenGL/LineCanvas/LineCanvas.vert").c_str());
	GLShader shdLinesFragment_ = GLShader((FilesystemUtilities::GetShadersDir() + "OpenGL/LineCanvas/LineCanvas.frag").c_str());
