		...
		: Renderer(ctx)
{
	...
	initPipeline({ (FilesystemUtilities::GetShadersDir() + "Vulkan/InfinitePlaneRenderer/InfinitePlaneRenderer.vert").c_str(), (FilesystemUtilities::GetShadersDir() + "Vulkan/InfinitePlaneRenderer/InfinitePlaneRenderer.frag").c_str() }, pInfo);
}
