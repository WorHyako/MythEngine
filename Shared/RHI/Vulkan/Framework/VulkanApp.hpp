...
struct VulkanRenderContext
{
    ...
    VulkanRenderContext(void* window, uint32_t screenWidth, uint32_t screenHeight, const VulkanContextFeatures& ctxFeatures = VulkanContextFeatures())
		...
		, finishRenderPass(resources.addFullScreenPass(true, RenderPassCreateInfo{false, false, eRenderPassBit_Last}))
		, clearRenderPass(resources.addFullScreenPass(true, RenderPassCreateInfo{true, true, eRenderPassBit_First}))
